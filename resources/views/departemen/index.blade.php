                  ...
                  <div class="row">
                    <div class="col-10">
                      <div class="form-group">
                        ...
                        class="form-control" placeholder="Departemen" value="{{ Request('nama_dept') }}">
                      </div>
                    </div>
          ...
          <div class="row">
            <div class="col-12">
              <div class="input-icon mb-3">
                ...
                <input type="text" value="" class="form-control" id="nik" name="nama_dept" placeholder="Nama Departemen">
              </div>
            </div>
          </div>
